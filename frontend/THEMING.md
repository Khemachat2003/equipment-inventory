...
| 2026-09-09 | — | Dashboard: redesign พรีเมียม (ใช้ token เดิม) — hero gradient (ตัวเลขจับต้อง totandlerItems + refresh), glass KPI 4 ใบ (Office/Site/เบิก/คืนวันนี้), KPI cards (ฟาร์ม/ติดตั้ง/สต็อก), สถานะอุปกรณ์แบบ progress bar (4 สถานะ), อันดับฟาร์มติดตั้งสูงสุด + แถบ rank; chart ใช้ segmented range control |